...
// Parsing is the process of decoding information into something
// usable by a machine

// bodyParser extracts the entire body portion of an incoming request 
// stream and exposes it on req.body as something easier to interface with.
// bodyParser.json parses the text as JSON and exposes the resulting
// object on req.body
...
router.post('/', jsonParser, (req, res) => {
    ...
    // If username or password isn't trimmed, we give an error!
...
// If user with requested name already exists, promise is rejected
